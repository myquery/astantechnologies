...
const pillar = PILLARS["software-development"];
const articles = blogArticles.filter((a) => a.pillar === "software-development");

export default function SoftwareDevelopmentPillar() {
  return (
    <>
      <Head>
